...
```
git clone https://github.com/arnavk23/AI-Scheduling-Assistant.git
...
#### Follow the notebook for example usage : [Calendar_Event_Extraction](https://github.com/arnavk23/AI-Scheduling-Assistant/blob/main/Calendar_Event_Extraction.ipynb)
...
```
#### For setting up vLLM server with DeepSeek Model & usage, please follow : [vLLM_Inference_Servering_DeepSeek](https://github.com/arnavk23/AI-Scheduling-Assistant/blob/main/vLLM_Inference_Servering_DeepSeek.ipynb)
...
#### Follow the Notebook for setting-up an example AI Agent : [Sample_AI_Agent](https://github.com/arnavk23/AI-Scheduling-Assistant/blob/main/Sample_AI_Agent.ipynb)
...
#### Please follow : [Submission Notebook](https://github.com/arnavk23/AI-Scheduling-Assistant/blob/main/Submission.ipynb)
